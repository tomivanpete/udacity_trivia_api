  ...
  '''
    ...
    def play_quiz():
        try:
            ...
            # If there are no previous questions, then we can return a random
            # choice from all available questions
            if len(previous_questions) == 0:
                ...
                # Remove previous questions from the
                # selection of possible new questions
                for id in previous_questions:
                    for question in formatted_questions:
                        if id == question['id']:
                            formatted_questions.remove(question)
                # If all questions have been removed,
                # then return None for question
